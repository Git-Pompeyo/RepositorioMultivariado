...
$$ Calcule los coeficientes $\hat{\beta_0}$ y $\hat{\beta_1}$ utilizando el método de mínimos cuadrados y compare este resultado con el obtenido utilizando R.
...
$$ Se sigue que $$
(x-\bar{x}1_{5}) = (-3.74, 1.26, -2.53, 2.21, 2.78)
$$ y $$
(y-\bar{y}1_{5}) = (-5.33, 2.6, -2.54, 2.19, 3.07)
$$ Por tanto $$
s_{x}^{2} = (-3.74)^2 + (1.26)^2+(-2.53)^2 + (2.21)^2 + (2.78)^2 = 34.58
$$ y $$
s_{xy} = (-3.74)(-5.33) + (1.26)(2.6)+(-2.53)(-2.54) + (2.21)(2.19) + (2.78)(3.07) = 43.01
$$ Se sigue que $$
\hat{\beta}_{1} = \frac{s_{xy}}{s_{x}^{2}} = 43.01/34.58 = 1.24
$$ Por otro lado, $$
\hat{\beta}_{0} = \bar{y}- \hat{\beta}_{1}\bar{x} = 6.52 - (1.24)(6.62) = -1.69
