...
**Definición.** Una *transformación afín* de una variable aleatoria $X$ es una transformación de la forma $$
Y = aX + b
...
**Observación.** Si $X$ no es normal, entonces $Z$ *no* será normal estándar. La estandarización no transforma una distribución no normal en una distribución normal. Notemos además que, por definición, $$
...
Como ejemplo, consideraremos la distribución Gamma con parámetros $\alpha = 2$ y $\beta = 1$. En este caso la media y la desviación estándar están dadas por: $$
\begin{aligned}
