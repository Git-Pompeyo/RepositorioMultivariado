...
pew_plot <- pew_grouped %>%
  ggplot(aes(x = fct_reorder(religion, count, .desc = TRUE), y = count, fill = income)) +
  geom_col() +
...
3. For the Pew dataset, we generated a column plot, but in this case we stacked the bars for easy reference. I also flipped the axes to make the plot more readable. 
