...
\begin{definition}
Let $X$ be a continuous random variable following a \alert{Gamma distribution} with shape parameter $\alpha > 0$ and rate parameter $\beta > 0$. The probability density function (PDF) of $X$ is given by
...
The kurtosis of a normal distribution is 3, and it is often adjusted to be 0 for comparison purposes.

### Laplace Distribution

\begin{definition}
Let $X$ be a continuous random variable following a \alert{Laplace distribution} with location parameter $\mu \in \mathbb{R}$ and scale parameter $b > 0$. The probability density function (PDF) of $X$ is given by
...
They are particularly useful for assessing whether a dataset follows a normal distribution. 
