...
```{r}
#| fig-cap: "Diagrama de dispersión del conjunto de datos Iris, separado por especie y considerando únicamente las variables 'Sepal.Length' y 'Sepal.Width'."
#| fig-width: 6
#| fig-height: 4
...
```{r}
#| fig-cap: "Agrupamiento jerárquico del conjunto de datos Iris considerando únicamente las variables 'Sepal.Length' y 'Sepal.Width'. Las líneas punteadas indican los puntos de corte para los números de clústeres dados (k = 1, 3, 4, 6)."
#| fig-width:  10
#| fig-height: 12
