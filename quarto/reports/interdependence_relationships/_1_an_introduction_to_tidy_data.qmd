...
\begin{enumerate}
\item En la sección anterior se mostró cómo usar el operador \texttt{|>} para encadenar múltiples operaciones en el Tidyverse. En este ejercicio, muestre el resultado de todos los pasos intermedios en el proceso de ordenamiento del conjunto de datos `who` usando el operador pipe.
