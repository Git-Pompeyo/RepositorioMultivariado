...
\begin{remark}
En estadística, a menudo se habla de \emph{escalamientos} (aunque incluyan traslaciones) para referirse a transformaciones afines.
\end{remark}
...
\begin{enumerate}
    \item \textbf{Estandarización.} Usa la media y la desviación estándar muestrales. En otras palabras, la muestra estandarizada está dada por
    $$
    T = \frac{X - \bar{X}}{S},
    $$
    donde $\bar{X}$ es la media muestral y $S$ es la desviación estándar muestral. 
    
    \item \textbf{Escalamiento Min–Max.} En este caso la muestra escalada está dada por
    $$
    ...
    \item \textbf{Escalamiento robusto.} Usa la mediana y el rango intercuartil (IQR). La muestra escalada es
    $$
    ...
    \item \textbf{Normalización.} Divide cada dato por la norma del vector. La muestra normalizada es
    $$
    T = \frac{X}{\|X\|},
    $$
